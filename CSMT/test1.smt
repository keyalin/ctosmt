...
;(assert(> (charOf staticString 0) (charOf inputString 0)))
(check-sat)
(assert (forall ((index Int)) (ite (and (>= index 0) (< index 4)) (= (charOf inputString index) (charOf staticString index) true)))
(assert (forall ((index Int)) (ite (and (>= index 0) (< index 4)) (= (charOf inputString index) (charOf staticString index)) true)))
