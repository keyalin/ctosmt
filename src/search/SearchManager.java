...
import test.Test;
import translators.SSATranslator;
...
//			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("ctest/test/temp1")));
//			loadAllVariable(translator, bw);
//			loadVariableFromInput(bw, input);
